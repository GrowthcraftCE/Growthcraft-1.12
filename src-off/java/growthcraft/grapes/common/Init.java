...
public class Init {
    ...
    public static void registerBlocks() {
    	GrowthcraftGrapesBlocks.grapeVine0.register(new ResourceLocation(Reference.MODID, "native_grape_vine0"), false);
    	GrowthcraftGrapesBlocks.grapeVine1.register(new ResourceLocation(Reference.MODID, "native_grape_vine1"), false);
    	GrowthcraftGrapesBlocks.grapeLeaves.register(new ResourceLocation(Reference.MODID, "native_grape_vine_leaves"), false);
    	GrowthcraftGrapesBlocks.grapeFruit.register(new ResourceLocation(Reference.MODID, "native_grape_fruit"), false);
    }
    ...
    public static void registerItems() {
    	...
    	GrowthcraftGrapesItems.grape.register();
    	GrowthcraftGrapesItems.grape_seed.getItem().setCreativeTab(tabGrowthcraft);
    	GrowthcraftGrapesItems.grape_seed.register();
