...
import growthcraft.hops.init.GrowthcraftHopsItems.HopAleTypes;
import growthcraft.hops.init.GrowthcraftHopsItems.LagerTypes;
...
public class Init {
    ...
    public static void registerBlocks() {
    	GrowthcraftHopsBlocks.hops.register(false);
    }
	...
	public static void registerFluids() {
		...
		BoozeRegistryHelper.registerBooze(GrowthcraftHopsFluids.hopAleBooze, GrowthcraftHopsBlocks.hopAleFluidBlocks, GrowthcraftHopsItems.hopAleBottle, Reference.MODID, "hopalebooze", HopAleTypes.class);
		GrowthcraftHopsItems.lagerBottle.getItem().setBoozes(GrowthcraftHopsFluids.lagerBooze);
		BoozeRegistryHelper.registerBooze(GrowthcraftHopsFluids.lagerBooze, GrowthcraftHopsBlocks.lagerFluidBlocks, GrowthcraftHopsItems.lagerBottle, Reference.MODID, "lagerbooze", LagerTypes.class);
