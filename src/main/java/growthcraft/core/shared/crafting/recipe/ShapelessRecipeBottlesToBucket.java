...
public class ShapelessRecipeBottlesToBucket extends ShapelessOreRecipe {

    public ShapelessRecipeBottlesToBucket(@Nullable ResourceLocation group, NonNullList<Ingredient> input, @Nonnull ItemStack result) {
