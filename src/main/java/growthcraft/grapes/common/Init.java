...
public class Init {
	...
	private static void registerFermentations() {
		...
		final FluidStack[] spoilInputFs = new FluidStack[grapeWineBooze.length];
		for (int i = 0; i < grapeWineBooze.length; ++i)
		{
			spoilInputFs[i] = grapeWineBooze[i].asFluidStack(GrowthcraftGrapesConfig.portWineBrewingYield);
		}
		...
		GrowthcraftCellarApis.boozeBuilderFactory.create(grapeWineBooze[WineTypes.PURPLE_WINE_POISONED.ordinal()].getFluid())
			...
			.fermentsFrom(fs[WineTypes.PURPLE_WINE_POTENT.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.PURPLE_WINE_POTENT.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.PURPLE_WINE_POTENT.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.PURPLE_WINE_EXTENDED.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.PURPLE_WINE_EXTENDED.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.PURPLE_WINE_EXTENDED.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.PURPLE_AMBROSIA.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.PURPLE_AMBROSIA.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.PURPLE_AMBROSIA.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.PURPLE_PORTWINE.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.PURPLE_PORTWINE.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.PURPLE_PORTWINE.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.PURPLE_WINE_INTOXICATED.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.PURPLE_WINE_INTOXICATED.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.PURPLE_WINE_INTOXICATED.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFromFallback(fs[WineTypes.PURPLE_WINE_POISONED.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.PURPLE_WINE_POISONED.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.getEffect()
				.setTipsy(BoozeUtils.alcoholToTipsy(0.05f), TickUtils.seconds(90))
		...
		GrowthcraftCellarApis.boozeBuilderFactory.create(grapeWineBooze[WineTypes.RED_WINE_POISONED.ordinal()].getFluid())
			...
			.fermentsFrom(fs[WineTypes.RED_WINE_POTENT.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.RED_WINE_POTENT.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.RED_WINE_POTENT.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.RED_WINE_EXTENDED.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.RED_WINE_EXTENDED.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.RED_WINE_EXTENDED.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.RED_AMBROSIA.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.RED_AMBROSIA.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.RED_AMBROSIA.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.RED_PORTWINE.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.RED_PORTWINE.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.RED_PORTWINE.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.RED_WINE_INTOXICATED.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.RED_WINE_INTOXICATED.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.RED_WINE_INTOXICATED.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFromFallback(fs[WineTypes.RED_WINE_POISONED.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.RED_WINE_POISONED.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.getEffect()
				.setTipsy(BoozeUtils.alcoholToTipsy(0.05f), TickUtils.seconds(90))
				.createPotionEntry(MobEffects.POISON, TickUtils.seconds(90), 0)
				.toggleDescription(!GrowthcraftCoreConfig.hidePoisonedBooze);
		GrowthcraftCellarApis.boozeBuilderFactory.create(grapeWineBooze[WineTypes.GREEN_WINE_POISONED.ordinal()].getFluid())
			...
			.fermentsFrom(fs[WineTypes.GREEN_WINE_POTENT.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.GREEN_WINE_POTENT.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.GREEN_WINE_POTENT.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.GREEN_WINE_EXTENDED.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.GREEN_WINE_EXTENDED.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.GREEN_WINE_EXTENDED.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.GREEN_AMBROSIA.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.GREEN_AMBROSIA.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.GREEN_AMBROSIA.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.GREEN_PORTWINE.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.GREEN_PORTWINE.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.GREEN_PORTWINE.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFrom(fs[WineTypes.GREEN_WINE_INTOXICATED.ordinal()], new OreItemStacks("yeastPoison"), fermentTime).fermentsFromFallback(fs[WineTypes.GREEN_WINE_INTOXICATED.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.GREEN_WINE_INTOXICATED.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.fermentsFromFallback(fs[WineTypes.GREEN_WINE_POISONED.ordinal()], fermentTime)
				.brewsFromFallback(spoilInputFs[WineTypes.GREEN_WINE_POISONED.ordinal()], GrowthcraftGrapesConfig.portWineBrewingTime, null)
			.getEffect()
				.setTipsy(BoozeUtils.alcoholToTipsy(0.05f), TickUtils.seconds(90))
				.createPotionEntry(MobEffects.POISON, TickUtils.seconds(90), 0)
				.toggleDescription(!GrowthcraftCoreConfig.hidePoisonedBooze);
